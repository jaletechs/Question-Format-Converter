...
import com.jaletechs.www.converter.controller.MoodleFormatController;
import com.jaletechs.www.converter.model.QuestionDocumentFormat;

public class MoodleFormatView extends JPanel implements MoodleFormatController.Display{
	...
	public MoodleFormatView(){
		setBorder(BorderFactory.createTitledBorder("Convert Between Moodle Formats"));
		
		finalPanel = new JPanel();
		//finalPanel.setBorder(BorderFactory.createLineBorder(Color.GRAY));
		finalPanel.setLayout(new BoxLayout(finalPanel, BoxLayout.Y_AXIS));
		JLabel icon = new JLabel(new ImageIcon(getClass().getResource("moodle.png")));
		//icon.setText("oodle");
		...
		formatsPanel.setBorder(BorderFactory.createTitledBorder("Moodle Formats"));
		...
		MoodleFormatController controller = new MoodleFormatController(this);
	}
